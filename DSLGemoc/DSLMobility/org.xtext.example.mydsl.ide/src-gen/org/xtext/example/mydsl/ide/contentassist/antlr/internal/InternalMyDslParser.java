...
public class InternalMyDslParser extends AbstractInternalContentAssistParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_STRING", "RULE_ID", "RULE_INT", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'tisseo'", "'google'", "'Page'", "'source'", "','"
    };
    ...
    // InternalMyDsl.g:164:1: rule__SourceName__Alternatives : ( ( ( 'tisseo' ) ) | ( ( 'google' ) ) );
    public final void rule__SourceName__Alternatives() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalMyDsl.g:168:1: ( ( ( 'tisseo' ) ) | ( ( 'google' ) ) )
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalMyDsl.g:175:2: ( ( 'google' ) )
                    {
                    // InternalMyDsl.g:175:2: ( ( 'google' ) )
                    // InternalMyDsl.g:176:3: ( 'google' )
                    {
                     before(grammarAccess.getSourceNameAccess().getGoogleMapEnumLiteralDeclaration_1()); 
                    // InternalMyDsl.g:177:3: ( 'google' )
                    // InternalMyDsl.g:177:4: 'google'
                    {
