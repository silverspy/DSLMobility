 ...
 * @generated
 */
public class DSLMobilityFactoryImpl extends EFactoryImpl implements DSLMobilityFactory {
	/**
	 ...
	 * @generated
	 */
	public static DSLMobilityFactory init() {
		try {
			DSLMobilityFactory theDSLMobilityFactory = (DSLMobilityFactory) EPackage.Registry.INSTANCE
					.getEFactory(DSLMobilityPackage.eNS_URI);
			if (theDSLMobilityFactory != null) {
				return theDSLMobilityFactory;
			}
		} catch (Exception exception) {
			EcorePlugin.INSTANCE.log(exception);
		}
		return new DSLMobilityFactoryImpl();
	}
	 ...
	 * @generated
	 */
	public SourceName createSourceNameFromString(EDataType eDataType, String initialValue) {
		SourceName result = SourceName.get(initialValue);
		if (result == null)
	 ...
	 * @generated
	 */
	public DSLMobilityPackage getDSLMobilityPackage() {
		return (DSLMobilityPackage) getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static DSLMobilityPackage getPackage() {
		return DSLMobilityPackage.eINSTANCE;
	}

} //DSLMobilityFactoryImpl
